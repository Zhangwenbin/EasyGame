...
public class ExportConfig
{
	...
	public void Init()
	{
		...
		ClientExportInfo.ExportPath = Path.Combine(appPath, "../Assets/Scripts/Config/AutoGenerateConfig");
		...
		ClientExportConfigInfo.ExportPath = Path.Combine(appPath, "../Assets/Res/Config");
