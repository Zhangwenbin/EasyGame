...
namespace FMODUnity
{
    ...
    public class StudioEventEmitterEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var bank = serializedObject.FindProperty("bank");
            ...
            {
                {
                    ...
                    bank.stringValue= editorEvent.Banks.Select(x => x.Name).ToArray().First();
                    EditorGUILayout.PropertyField(bank, new GUIContent("Bank"));
                    EditorGUI.EndDisabledGroup();
                }
