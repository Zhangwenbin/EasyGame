...
{
    unsafe class EG_basicCall_Binding
    {
        ...
        static StackObject* Add_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            EG.basicCall instance_of_this_method = (EG.basicCall)typeof(EG.basicCall).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            instance_of_this_method.Add(@a, @b);
