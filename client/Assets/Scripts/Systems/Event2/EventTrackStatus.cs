...
namespace EG
{
    ...
    public class EventTrackStatus
    {
        ...
        {
            public EG.AppMonoBehaviour behaviour;
        ...
        public virtual void Initialize( EG.AppMonoBehaviour behaviour, EventTrack track )
        {
            m_Track = track;
        ...
        public virtual void Release( EG.AppMonoBehaviour behaviour )
        {
        ...
        public virtual void Clear( EG.AppMonoBehaviour behaviour )
        {
            if( m_State == PlayState.Active )
            {
                // 
        ...
        public virtual void LoopStart( EG.AppMonoBehaviour behaviour, float time )
        {
        ...
        //todo  no SerializeValueBehaviour
        // protected void CacheTarget( EG.AppMonoBehaviour behaviour, string targetId, ref ObjectCache cache )
        // {
        ...
        public bool UpdateEvent( EG.AppMonoBehaviour behaviour, float time, float deltaTime )
        {
            #if UNITY_EDITOR
            // 
        ...
        protected virtual void OnStart( EG.AppMonoBehaviour behaviour )
        {
            m_Track.OnStart( behaviour );
        }
        

        protected virtual void OnUpdate( EG.AppMonoBehaviour behaviour, float time )
        {
            m_Track.OnUpdate( behaviour, time );
        }
        

        protected virtual void OnEnd( EG.AppMonoBehaviour behaviour )
        {
            m_Track.OnEnd( behaviour );
        }
        

        protected virtual void OnBackground( EG.AppMonoBehaviour behaviour, float time )
        {
        ...
        public bool EditorUpdateEvent( EG.AppMonoBehaviour behaviour, float time, float deltaTime, bool isSeek )
        {
        ...
        //todo no SerializeValueBehaviour
        // static public GameObject CacheTargetOnEditor( EG.AppMonoBehaviour behaviour, string targetId )
        // {
        ...
        protected virtual void ReCacheTarget( EG.AppMonoBehaviour behaviour )
        {
        }
        ...
        public void EditorPreProcess( EG.AppMonoBehaviour behaviour, float time, float dt, bool isLooped, bool isEnded )
        {
            EventTrack.CurrentStatus = this;
        ...
        public void EditorPostProcess( EG.AppMonoBehaviour behaviour, float time, float dt, bool isLooped, bool isEnded )
        {
            EventTrack.CurrentStatus = this;
