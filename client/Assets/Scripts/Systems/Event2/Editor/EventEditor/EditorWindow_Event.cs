...
namespace EG
{
    ...
    public partial class EditorWindow_Event : EditorWindow
    {
        ...
        private void Initialize( )
        {
            ...
            //     {
            //         SoundManager.DebugDestroy();
            //     }
            // }
            //
            // if ( SoundManager.HasInstance() == false )
            // {
            //     SoundManager.Instance.Initialize();
            //     SoundManager.Instance.EditorLoadSEAll();
            // }
            //
            // if( MasterParam.HasInstance() == false )
            // {
            //     MasterParam.CreateSingleton();
            // }
        ...
        private void Release( )
        {
            ...
            //todo
            // if( MasterParam.HasInstance() )
            // {
            //     MasterParam.Instance.Release();
            //     MasterParam.DestroySingleton();
            // }
            //
            // if( SoundManager.HasInstance() )
            // {
            //     SoundManager.Instance.EditorUnloadSEAll();
            //     SoundManager.Instance.EditorRelease();
