...
namespace EG
{
    ...
    public class EventPlayerMachine : EG.AppMonoBehaviour
    {
        [System.Serializable]
        public class Param
        {
            ...
            [CustomFieldEditorButtonAttribute("open",CustomFieldEditorButtonAttribute.Button1)]
            [CustomFieldAttribute("param", CustomFieldAttribute.Type.ScriptableObject,typeof(EventParam))]
            public EventParam       param;
        }
        
        
        
        [CustomFieldAttribute("Key to be played automatically",CustomFieldAttribute.Type.String)]
        public string                   AutoKey;
        
        [CustomFieldAttribute("Params", CustomFieldAttribute.Type.Objects,typeof(Param))]
        public Param[]                  Params;
        ...
        // private TempList<string>        m_EventNameQueue;
        ...
        public EventPlayer              Player
        {
            get
            {
                if( m_Player == null ) m_Player = gameObject.RequireComponent<EventPlayer>( );
                return m_Player;
            }
        }
