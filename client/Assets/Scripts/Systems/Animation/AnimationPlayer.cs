...
namespace EG
{
    public class AnimationPlayer
    {
        ...
        public bool Play(AnimationClip clip, float blend_time = 0, int mixer_layer = 0)
        {
            if (clip == null)
            {
                Debug.LogWarning("Animation" + ">>>>> Play(): clip null");
                ResetFlag();
                return false;
            }
            ...
            for (int i = _play_statuss.Count - 1; i >= 0; --i)
            {
                ...
                {
                    // clipなしは即時削除
                    //if (_play_statuss[i].PlayState == PlayState.NoClip)
                    //{
                    //    StopAnimation(_play_statuss[i].Name);
                    //}
                    //else
                    {
        ...
        {
            //AnimationStateSource state = FindState( id );
            //if( state == null )
            //{
            //    return 0;
            //}
        ...
        public float GetNormalizedTime(string id)
        {
            ...
            //return state.AnimDef.PlayTime / state.AnimDef.Length;
            return 0.0f;
        }
        ...
        //[UnityEditor.CustomEditor(typeof(AnimationPlayer))]
        //public class EditorInspector_AnimationPlayer: UnityEditor.Editor
        //{
        ...
        //        for( int i = 0; i < player.mAnimLoadRequests.Count; ++i )
        //        {
        //            UnityEditor.EditorGUILayout.BeginHorizontal( );
        //            GUILayout.Space( 10 );
        //            UnityEditor.EditorGUILayout.LabelField( player.mAnimLoadRequests[ i ].path );
        //            UnityEditor.EditorGUILayout.EndHorizontal( );
        //        }

        //        GUILayout.Space( 10 );

        //        UnityEditor.EditorGUILayout.LabelField( "Loaded Animations:" );
        //        foreach( string key in player.mLoadedAnimations.Keys )
        //        {
        //            UnityEditor.EditorGUILayout.BeginHorizontal( );
        //            GUILayout.Space( 10 );
        //            UnityEditor.EditorGUILayout.LabelField( player.mLoadedAnimations[ key ].name );
        //            UnityEditor.EditorGUILayout.EndHorizontal( );
        //        }
