...
namespace EG
{
    ...
    public class UIEaseManager
    {
        ...
        public static float EasingFromType(float start, float end, float t, UIEaseType type){
            switch (type){
