...
namespace EG
{
	...
	public class WindowManager : MonoSingleton<WindowManager>
	{
		...
		public UIWindow OpenWindow<T>( System.Object userData = null) where T : UIWindow
		{
			return OpenWindow(typeof(T), userData);
		}
		public UIWindow OpenWindow(Type type, System.Object userData = null)
		{
			string windowName = type.FullName;
			...
			else
			{
				...
				Push(window); //首次压入
				window.InternalLoad(window.WindowResource, OnWindowPrepare, userData);
				return window;
			}
		}
