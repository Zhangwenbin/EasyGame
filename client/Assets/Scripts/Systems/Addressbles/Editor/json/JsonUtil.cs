...
namespace EG
{
	public class JsonUtil
	{
        ...
        public static void InitJson()
        {
            ...
            JSON.RegisterCustomType(typeof(UnityEngine.Vector2), Vector2Jason.SerializeVector2, Vector2Jason.DeserializeVector2);
            JSON.RegisterCustomType(typeof(UnityEngine.Vector3), Vector3Jason.SerializeVector3, Vector3Jason.DeserializeVector3);
            JSON.RegisterCustomType(typeof(UnityEngine.Vector4), Vector4Jason.SerializeVector4, Vector4Jason.DeserializeVector4);
