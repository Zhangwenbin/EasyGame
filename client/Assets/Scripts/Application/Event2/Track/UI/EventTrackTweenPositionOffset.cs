...
namespace EG
{
    public class EventTrackTweenPositionOffset : EventTrackTweener
    {
        public class Status : StatusBase
        {
            public Vector2 Value
            {
                set
                {
                    ...
                    if( trs != null )
                    {
                        trs.anchoredPosition = m_DefaultPosition + value;
                    }
                }
                get
                {
                    ...
                    if( trs != null )
                    {
                        return trs.anchoredPosition - m_DefaultPosition;
                    }
                    return Vector2.one;
                }
            }
        ...
        new public static string    ClassName   { get { return "Tween/坐标偏移";     } }
